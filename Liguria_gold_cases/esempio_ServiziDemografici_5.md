...
**INPUT UTENTE:**
> Ho ricevuto un provvedimento di cancellazione anagrafica per irreperibilità da parte del Comune di Genova. Mi piacerebbe una verifica critica del procedimento, soprattutto per verificare se tutti i passaggi normativi obbligatori sono stati seguiti. È un tipo di provvedimento che anche Ameglia potrebbe emettere nei prossimi mesi.
>
> **DOCUMENTO ALLEGATO:**
>
> ---
...
>
> Il Sindaco del Comune di Genova,
>
> Considerato che presso l'anagrafe del Comune di Genova risulta iscritto il sig. Marco Vitali, codice fiscale VTLMRC78A15A261P, in precedenza residente in Via Tolomei 44, Genova;
>
...
>
> È cancellato dall'anagrafe del Comune di Genova il sig. Marco Vitali, CF VTLMRC78A15A261P, in precedenza residente in Via Tolomei 44.
>
> **Art. 2** – Effetti
>
...
7. **Formula dispositiva carente:** "È cancellato dall'anagrafe" è generico. Migliore sarebbe: "Si cancella dall'anagrafe la registrazione anagrafica del sig. Marco Vitali, CF VTLMRC78A15A261P, con effetto dal [data decorrenza], per irreperibilità, risultando non rintracciabile presso l'ultimo domicilio noto".
...
- **Secondo accertamento:** almeno marzo 2026 (MANCANTE nel provvedimento di Genova)

Se il Sindaco di Genova ha emesso l'ordinanza il 18 marzo 2026 ma cita solo l'accertamento di settembre 2025, non ha atteso i 180 giorni completi. Oppure ha effettuato il secondo accertamento ma non lo menziona nel provvedimento, il che è un'omissione documentale grave.

Se a Ameglia riceviamo una richiesta di cancellazione per irreperibilità, dobbiamo verificare rigorosamente:
...
**INPUT UTENTE:**
> Capito. Allora prepariamo il provvedimento corretto per il nostro caso. Abbiamo il sig. Marco Vitali — no, scusami, il sig. Marco Vitali è di Genova. Per Ameglia il caso è diverso: si tratta della sig. Alessia Rossi, CF RSSALS85M41A261Y, che era iscritta in anagrafe presso Via della Marina 33. Primo accertamento negativo effettuato dalla Polizia Municipale il 15 settembre 2025, secondo accertamento negativo il 20 marzo 2026. Abbiamo tentato anche di notificarle una comunicazione ufficiale il 10 marzo 2026, rimasta senza risposta. Provvedimento: ordinanza sindacale n. 29/2026 del 28 marzo 2026. Sindaco: Dott. Francesco Bianchi.
...
Oggetto: Cancellazione da anagrafe per irreperibilità — Sig.ra Alessia Rossi, CF RSSALS85M41A261Y
...
Considerato che presso l'anagrafe del Comune di Ameglia risulta iscritta la sig.ra Alessia Rossi, codice fiscale RSSALS85M41A261Y, precedentemente residente in Via della Marina 33, Ameglia;

Considerato che la sig.ra Rossi è introvabile presso il domicilio indicato;

Considerato che è stato effettuato il **primo accertamento di irreperibilità** dalla Polizia Municipale di Ameglia in data 15 settembre 2025, con esito negativo, documentato nel fascicolo di protocollo n. [N. verbale];

Considerato che è stato effettuato il **secondo accertamento di irreperibilità** dalla Polizia Municipale di Ameglia in data 20 marzo 2026, a distanza di 187 giorni dal primo accertamento, conforme ai requisiti di cui all'art. 11, comma 1, DPR 223/1989, con esito negativo, documentato nel fascicolo di protocollo n. [N. verbale];
...
Si cancella dall'anagrafe del Comune di Ameglia la registrazione anagrafica della sig.ra Alessia Rossi, codice fiscale RSSALS85M41A261Y, precedentemente residente in Via della Marina 33, Ameglia, con decorrenza dal 28 marzo 2026. La cancellazione è disposta per irreperibilità, a seguito di due accertamenti negativi effettuati a distanza di 187 giorni, secondo i termini di cui all'art. 11, comma 1, DPR 223/1989.

Art. 2 – Effetti della cancellazione

A decorrere dalla data di cui all'art. 1, la sig.ra Alessia Rossi cessa di essere iscritta in anagrafe presso il Comune di Ameglia. Conseguentemente:
a) Perde la qualità di residente nel Comune di Ameglia;
...
Il Servizio Demografico del Comune di Ameglia comunica la presente cancellazione, entro 15 giorni dalla sottoscrizione della presente ordinanza, a:
a) ISTAT — Istituto Nazionale di Statistica (per aggiornamento dati statistici);
b) Prefettura della Spezia (per anagrafe provinciale);
c) ASL Liguria Nord Ovest (per cancellazione da liste SSN);
...
Sig.ra Alessia Rossi, CF RSSALS85M41A261Y
...
Si apre la finestra AgentSaveDialog. L'utente seleziona cartella e formato (PDF, DOCX, ODT). Il file viene salvato con naming convention: `Ameglia_ORD_29_2026_Cancellazione_Rossi_Alessia.pdf`. L'agente conferma:

"Atto salvato con successo in cartella [percorso]. Nome file: `Ameglia_ORD_29_2026_Cancellazione_Rossi_Alessia.pdf`. Operazione completata."
